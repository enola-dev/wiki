...
- **Hermes Agent & OpenClaw Integration**: Supported natively as an external memory provider in autonomous agent runtimes like [[hermes-memory-providers]] and Claude Code setups.
...
- [[hermes-memory-providers]] - Overview of memory providers in Hermes Agent.
- [[letta]] - Stateful agent framework with self-editing core memory.
- [[mem0]] - Personalized memory layer with multi-level scoping.
