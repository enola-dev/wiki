...
- [[mem0]] - Vector-first intelligent memory layer.
- [[honcho]] - User-modeling and dialectic reasoning engine.
- [[hermes-memory-providers]] - Memory provider integrations for autonomous agents.
