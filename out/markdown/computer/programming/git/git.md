...
- [Git Reftable Storage Backend](reftable.md): A binary, transactional reference storage format designed for high performance and atomic updates in repositories with large numbers of refs.
