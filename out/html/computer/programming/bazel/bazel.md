...
In standard non-Nix environments, developers often manage Bazel versions using launcher tools like [Bazelisk Launcher](bazelisk.md). In [Nix Package Manager](../nix/nix.md) projects, Bazel is provided directly via the development shell.
