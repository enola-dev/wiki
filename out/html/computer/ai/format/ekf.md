...
- **[Open Knowledge Format (OKF)](okf.md)**: File-based knowledge bundles with YAML frontmatter capturing provenance, trust, and lifecycles without requiring proprietary databases or runtime dependencies.
...
| **Markdown Quality** | Unconstrained CommonMark | Constrained by **[Well formed Markdown](well-formed-markdown.md)** (strict heading hierarchy, list formatting, no broken links). |
...
All documents must adhere to [Well formed Markdown](well-formed-markdown.md) constraints:
...
- [Well formed Markdown](well-formed-markdown.md)
- [https://docs.enola.dev/specs/markdown-magic-link/](https://docs.enola.dev/specs/markdown-magic-link/)
- [https://docs.enola.dev/specs/markdown-yamlld-frontmatter/](https://docs.enola.dev/specs/markdown-yamlld-frontmatter/)
...
- [https://github.com/glaforge/open-reasoning-format](https://github.com/glaforge/open-reasoning-format)
- [https://github.com/GoogleCloudPlatform/open-knowledge-format](https://github.com/GoogleCloudPlatform/open-knowledge-format)
